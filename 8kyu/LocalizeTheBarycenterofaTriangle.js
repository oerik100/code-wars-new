...
function barTriang(p1, p2, p3){
    ...
    let xP4 = p3[0]
    let xP5 = p3[1]
    let value1 = ((xP0 + xP2 + xP4)/3)
    let roundedValue1 = Number(value1.toFixed(4))
    let value2 = ((xP1 + xP3 + xP5)/3)
    let roundedValue2 = Number(value2.toFixed(4))
    let arr = [roundedValue1, roundedValue2]
    return arr
  }